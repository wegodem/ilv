...
void ExpectationValueRotation()
{
double hc[16][16][2],hb[16][16][2],hs[16][16][2],ht[16][16][2],oper[16][16][2];
double dw;
FILE   *inout,*out;
char   strtaddr1,strtaddr2,address1;            /* were of type ADDRESS */
int    k,l,dummy,storedensmat,j,ftype,fn,fndw; 
int    written,nbytes,nbytes1,read;         
double lr[3];
char   done;   /* was of type BOOLEAN   */
char   result; /* was of type DirResult */
...
void ExpectationOperator(n, Nspins, oper1)
int    *n,*Nspins;
double oper1[16][16][2];
/*eod*/
{
int choice;
/*eold*/
...
void MakeExpectationValueOperator(n, oper1)
int    *n;
double oper1[16][16][2];
/*eod*/
{
double oper[16][16][2],store1[16][16][2],store2[16][16][2],oper3[16][16][2];
int    i,type,choice,choice1;
double lr[3];
double mult;
/*eold*/
...
void CreateOperators(n, Nspins, oper)
int    *n,*Nspins;
double oper[16][16][2];
/*eod*/
{
int  count,i,j,sp,ntest,dummy,nlines,opno;
char symbolic[5],spinsymbol[5];
char chr;
/*eold*/
  ScreenMode(3);
  switch(Nspins)
...
/*eod*/
{
double store[16][16][2],store2[16][16][2];
int    i,j;
/*eold*/
